...
@section('title', 'Habitaciones en Mantenimiento')

@section('content')
<div class="container mx-auto p-6 bg-white shadow-md rounded">
    <h1 class="text-2xl font-bold mb-4">Habitaciones en Mantenimiento</h1>
    ...
    <table class="w-full border-collapse border border-gray-300">
        ...
        <tbody>
            ...
            @empty
                <tr>
                    <td colspan="5" class="border border-gray-300 px-4 py-2 text-center text-gray-500">No hay habitaciones en Mantenimiento.</td>
                </tr>
            @endforelse
        </tbody>
    </table>
